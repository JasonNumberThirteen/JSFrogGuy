class WaterFieldArea extends FieldArea {
	constructor(field, index, sizeInTiles) {
		super(field, index, FieldAreaType.Water, WATER_SPRITE_DIMENSIONS, sizeInTiles);
		this.#addTiles();
	}
	...
	#addTile(rowIndex, columnIndex) {
		const sprite = new WaterFieldTileSlicedSprite();
