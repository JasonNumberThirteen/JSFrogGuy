...
const GAME_VERSION_TEXT = "V.1.0";
const HIGH_SCORE_HEADER_TEXT = "HI-SCORE";
const PLAYER_SCORE_HEADER_TEXT = "1-UP";

// OFFSET FROM SCREEN EDGES
const PLAYER_LIVES_PANEL_UI_OFFSET_FROM_EDGES = 4;
const SCORE_GROUP_UI_OFFSET_FROM_SCREEN_EDGES = 8;
const PLAYER_LIVES_PANEL_UI_OFFSET_BETWEEN_SPRITES = 4;
const CURRENT_LEVEL_TEXT_UI_OFFSET_FROM_TOP_SCREEN_EDGE = 4;
const LEVEL_TIMER_PANEL_UI_OFFSET_FROM_BOTTON_SCREEN_EDGE = 4;

// DURATIONS
const FADE_SCREEN_FADE_DURATION = 1;
const MAIN_MENU_CURSOR_MOVEMENT_TIME = 1;
const START_GAME_TEXT_UI_BLINK_DELAY = 1;
const TURTLE_HIDING_ANIMATION_STEP_DELAY = 0.25;
...
const PLAYER_ADDITIONAL_LIFE_POINTS_THRESHOLD = 5000;
...
const LEVEL_TIMER_PANEL_UI_PROGRESS_BAR_BORDER_THICKNESS = 1;

// DIMENSIONS
const SINGLE_TILE_DIMENSIONS = new Point(8, 8);
const WATER_SPRITE_DIMENSIONS = SINGLE_TILE_DIMENSIONS;
const PLAYER_SPRITE_DIMENSIONS = SINGLE_TILE_DIMENSIONS;
const STREET_SPRITE_DIMENSIONS = SINGLE_TILE_DIMENSIONS;
const TURTLE_SPRITE_DIMENSIONS = SINGLE_TILE_DIMENSIONS;
const WALKWAY_SPRITE_DIMENSIONS = SINGLE_TILE_DIMENSIONS;
const VEHICLE_SPRITES_DIMENSIONS = [
	SINGLE_TILE_DIMENSIONS,
	SINGLE_TILE_DIMENSIONS,
	SINGLE_TILE_DIMENSIONS,
	SINGLE_TILE_DIMENSIONS,
	new Point(SINGLE_TILE_DIMENSIONS.x*2, SINGLE_TILE_DIMENSIONS.y)
];
const WOODEN_LOG_SPRITE_DIMENSIONS = SINGLE_TILE_DIMENSIONS;
const FROG_LOCATION_SPRITE_DIMENSIONS = new Point(24, 16);

// DIMENSIONS IN TILES
const WATER_HEIGHT_IN_TILES = 5;
const STREET_HEIGHT_IN_TILES = 5;
const WALKWAY_HEIGHT_IN_TILES = 1;
